      ...
      <iv-col :xs="24" :sm="24" :md="24" :lg="17">
        <div class="layout-left">
          ...
          <article-page-content>
            <article id="article-main-page" class="typo container" slot="content" ref="article" v-html="article.content_format">
            </article>
          </article-page-content>
          <article-page-footer :commentList="article.commentList"></article-page-footer>
        </div>
      </iv-col>
